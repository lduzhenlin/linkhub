...
public class DbConfigReader {
    ...
    public Map<String, String> loadConfigFromDb(Environment env) {
        try {
            ...
            // 查询启用的配置
            List<Entity> entities = db.query("SELECT * FROM sys_file_config WHERE enable = 1 LIMIT 1");

            if (entities.isEmpty()) {
                return Map.of();
            }

            Entity configEntity = entities.get(0);
