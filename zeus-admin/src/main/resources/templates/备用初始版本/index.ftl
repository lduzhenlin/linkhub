        ...
        <div class="flex items-center justify-between">
          ...
          <div class="flex items-center space-x-6">
            <div class="relative">
              ...
              <i id="searchBtn" class="fas fa-search absolute left-3 top-1/2 transform -translate-y-1/2 text-theme-secondary"></i>
            </div>
  ...
  <script>
    ...
    $(document).ready(function() {
      ...
      $('#editIcon').on('change', function() {
        ...
        $('#selectedIcon').attr('class', `fas {{= iconClass}} text-purple-500`);
      });
