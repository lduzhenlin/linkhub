...
public class UserController {
    ...
    public Object login(String tel, String password) {
        ...
        SysUser dbUser=sysUserService.getOne(Wrappers.<SysUser>lambdaQuery().eq(SysUser::getPassword,encodePassword).and(wrapper->wrapper.eq(SysUser::getUsername,tel).or().eq(SysUser::getTel,tel)));
